...
export class Core {
    ...
    public async getSeedFromMnemonic (mnemonic, password = null) {
    ...
    public getPublicFromPrivateKey (privateKey) {
    ...
    public generateDIDFromPublicKey (pubKey) {
